...
public class MinecraftCardWarsClient {
    public MinecraftCardWarsClient(ModContainer container) {
        ...
        // Do not forget to add translations for your config options to the pt_br.json file.
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        MinecraftCardWars.LOGGER.info("HELLO FROM CLIENT SETUP");
        MinecraftCardWars.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}
